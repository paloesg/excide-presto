Spree::FrontendHelper.class_eval do
  ...
  def taxons_tree(root_taxon, current_taxon, max_level = 1)
    ...
    taxons = root_taxon.children.map do |taxon|
      ...
      sub_taxons = safe_join(taxon.children.map { |t| '<li class="col-md-6 p-l-0">' + link_to(t.name, seo_url(t)) + '</li>' })
    ...
    if services.present?
      static_pages = services.map do |service|
        ...
        sub_taxons = safe_join(service.children.map { |t| '<li class="col-md-6 p-l-0">' + link_to(t.name, seo_url(t)) + '</li>' })
